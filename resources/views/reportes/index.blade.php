...
<div class="row">
    ...
    <div class="col-md-6 col-lg-4 mb-4">
        <div class="card h-100 shadow-sm hover-card">
            ...
            <div class="card-footer bg-transparent">
                <a href="{{ route('reportes.periodo') }}" class="btn btn-primary btn-sm w-100">
                    <i class="bi bi-play-circle"></i> Generar Reporte
                </a>
            </div>
        </div>
    ...
    <div class="col-md-6 col-lg-4 mb-4">
        <div class="card h-100 shadow-sm hover-card">
            ...
            <div class="card-footer bg-transparent">
                <a href="{{ route('reportes.productividad-inspectores') }}" class="btn btn-primary btn-sm w-100">
                    <i class="bi bi-play-circle"></i> Ver Reporte
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4 mb-4">
        <div class="card h-100 shadow-sm hover-card">
            ...
            <div class="card-footer bg-transparent">
                <a href="{{ route('reportes.estado-viviendas') }}" class="btn btn-primary btn-sm w-100">
                    <i class="bi bi-play-circle"></i> Ver Reporte
                </a>
            </div>
        </div>
    ...
    <div class="col-md-6 col-lg-4 mb-4">
        <div class="card h-100 shadow-sm hover-card">
            ...
            <div class="card-footer bg-transparent">
                <a href="{{ route('reportes.dashboard-ejecutivo') }}" class="btn btn-primary btn-sm w-100">
                    <i class="bi bi-play-circle"></i> Ver Dashboard
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4 mb-4">
        <div class="card h-100 shadow-sm hover-card">
            ...
            <div class="card-footer bg-transparent">
                <a href="{{ route('reportes.mapa-inspecciones') }}" class="btn btn-primary btn-sm w-100">
                    <i class="bi bi-play-circle"></i> Ver Mapa
                </a>
            </div>
        </div>
    </div>
